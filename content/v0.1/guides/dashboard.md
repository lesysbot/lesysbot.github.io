---
title: Dashboard
description: The local web dashboard: what it shows, how to enable and manage tools from it, and its security boundaries.
...
sysbot --provider cli --port 9000    # pick the port (implies --dashboard)
