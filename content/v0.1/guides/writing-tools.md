---
title: Writing tools
description: Author your own tools with @tool and CLITool — schemas, confirmation, and cross-platform gating.
section: Tools
...
a dict keyed by OS name (`linux` | `macos` | `windows`). SysBot runs the
